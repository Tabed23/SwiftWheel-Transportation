...
import servicebanner from "../../assets/images/blog-second.svg";
import servicetileimg from "../../assets/images/blogposter.png";
...
const Blog = () => {
  ...
  return (
    <>
    <section className="services-intro blog">
      <div className="container">
        <h1>Blog</h1>
      </div>
    </section>
    <section className="services-why blog-why">
      <div className="container">
        <div className="row">
            ...
            <div className="service-tile" >
              ...
              <div className="service-tile-grey-part">
                ...
                <div className="service-tile-btns">
                  ...
                  <button className="book-now-btn">Read Now</button>
                </div>
              </div>
